    ...
    return (
        <div>
            ...
            <div className=" space-y-4">
                ...
                <button aria-label="Log in with GitHub" className="flex items-center justify-center w-full p-2 space-x-4 border  border-black rounded-md focus:ring-2 focus:ring-offset-1 dark:border-gray-600 focus:dark:ring-default-600" onClick={handleGithub}>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" className="w-5 h-5 fill-current">
