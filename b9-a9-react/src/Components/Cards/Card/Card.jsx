...
const SingleCard = ({ card }) => {
    const { facilities, location, area, status, price, description, segment_name, estate_title, image ,id} = card
        ...
        <div>
            <Card className="w-full max-w-[26rem]  shadow-lg">
                ...
                <CardBody>
                    <div className="mb-3  items-center justify-between">
                        <Typography variant="h5" color="blue-gray" className="font-medium flex">
                            <FaMapSigns className="mr-1 mt-1"/>  {estate_title}.
                        </Typography>
                        <Typography variant="h5" color="blue-gray" className="font-medium flex">
                    ...
                    <Typography color="gray">
                        For: <span className="uppercase font-semibold mb-2">{status}</span> 
                    </Typography>
                    <Typography color="gray">
                       {description}
                    </Typography>
                ...
                <CardFooter className="pt-3">
                        ...
                        <Button size="lg" fullWidth={true}>View Details
                        </Button>
                        </NavLink>
