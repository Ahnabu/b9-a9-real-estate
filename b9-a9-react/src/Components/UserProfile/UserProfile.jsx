...
const UserProfile = () => {
    ...
    return (
        <div>
            <React.Fragment>
                <Button onClick={openDrawer} className="w-12 h-12 rounded-full  bg-cover dark:bg-gray-500" style={{ backgroundImage: `url(https://source.unsplash.com/100x100/?portrait)`}}>
